          ...
          <div className="flex w-max animate-marquee pause-on-hover hover:z-20 relative">
            {[
              ...
              <div
                ...
                className="mx-3 bg-white/5 border border-white/10 rounded-3xl p-6 backdrop-blur-sm transition-all duration-300 hover:bg-white/10 hover:scale-[1.02] cursor-default whitespace-normal"
              >
                ...
                <p className="text-gray-200 text-[15px] leading-relaxed mb-6 whitespace-normal break-words">"{testimonial.quote}"</p>
